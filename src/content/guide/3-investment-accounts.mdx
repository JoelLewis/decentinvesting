...
_Generally, fill these accounts in this order:_
...
<Callout type="tip" title="The biggest exception">
  If you have a near-term goal (house down payment, wedding, sabbatical) that you'll need *before*
  retirement, save for that in a taxable brokerage account or a high-yield savings account.
  Retirement accounts lock up your money — that's the trade-off for the tax benefits.
</Callout>
...
| **Tax on withdrawal**    | Taxed as ordinary income         | Tax-free (if qualified)                                |
| **Early withdrawal**     | Penalty + taxes                  | _Contributions_ can be withdrawn anytime, penalty-free |
...
The "triple tax advantage" — the only account type in the U.S. tax code that's tax-advantaged on the way in, while it grows, _and_ on the way out.
...
**The long-game strategy:** Many people pay medical bills out of pocket now, save the receipts, and let their HSA grow invested for decades. You can reimburse yourself for those old medical expenses _at any time in the future_.
...
<Callout type="warning">
  - **Not contributing enough to get the full employer match** — the closest thing to free money in
  investing. - **Ignoring the Roth option because "I want the tax break now"** — if you're in your
  20s-30s earning a moderate income, the Roth is almost certainly better. - **Contributing to a 529
  before maximizing retirement accounts** — your kids can get student loans; you can't get a
  retirement loan. - **Forgetting about the HSA** — the triple tax advantage makes it arguably the
  best account type available.
</Callout>
