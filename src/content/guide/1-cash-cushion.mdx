...
This money is **insurance**, not a savings account for wants. Before you tap it, ask: _is this unexpected, necessary, and urgent?_
...
<Callout type="warning">
  - **Keeping everything in checking at 0.01%** — you're losing ~$1,000+/year in interest on a $27K
  fund for no reason. - **Investing the emergency fund in stocks** — a market crash is often *the
  same time* you lose your job. Your emergency fund needs to be there when everything else is down.
  - **"I'll just use a credit card"** — credit lines can be reduced or revoked at the worst possible
  time, and 20%+ APR turns a $5,000 emergency into a $6,000+ debt spiral. - **Keeping too much
  cash** — beyond your target, excess cash has a real cost. Move the excess into investments. -
