...
If you have debt in the 5-8% gray zone and can't decide, split your extra money: half toward the debt, half toward investing. This is "good enough" — and good enough beats indecision.
</Callout>
...
- **Ignoring employer match to pay off low-rate debt** — a 50% match on your 401k beats paying off a 5% loan every time.
- **Consolidating debt into a longer term** — a lower monthly payment at a lower rate but over 10 more years can mean *more* total interest paid. Always compare total cost, not just the monthly number.
- **Paying off the mortgage early when you have credit card debt** — always attack the highest rate first.
- **Using home equity to pay off credit cards, then running up the cards again** — you've converted unsecured debt to secured debt and didn't fix the spending pattern.
- **Not making a plan** — "I'll pay extra when I can" leads to inconsistent payments. Pick a method, set a specific monthly amount, and automate it.
</Callout>
